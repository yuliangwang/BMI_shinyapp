...
shinyUI(pageWithSidebar(
    headerPanel(h2("Original and New Body Mass Index Calculator - your BMI and how much weight you need to lose/gain to be in shape")),
    sidebarPanel(
        ...
        p("Prof.Trefethen from University of Oxford proposes that a better approximation to the actual sizes and shapes of healthy bodies might be given by an exponent of 2.5."),
        p("When you provide your weight (in kilograms) and your height (in centimeters), this shiny app will calculate BMI based on both the original formula and the new formula proposed by Prof.Trefethen. Then it will tell you whether you are underweight, normal, overweight or obese."),
        p("In addtion, it will also calculate the minimum amount of weight loss/gain necessary to achieve normal BMI range (18.5-25) based on both formula."),
